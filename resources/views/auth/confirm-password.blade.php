                        ...
                        <div class="uk-grid uk-flex-center">
                            <div class="uk-width-2-3@m">
                                <div class="in-padding-horizontal@s">
                                    ...
                                    <!-- module logo begin -->
                                    <p class="uk-margin-top uk-margin-remove-bottom">This is a secure area of the application. Please confirm your password before continuing.</p>
                                    ...
                                    <form class="uk-grid uk-form" method="POST" action="{{ route('password.confirm') }}"> 
                                        ...
                                        <div class="uk-margin-small uk-width-1-1">
                                            <button class="uk-button uk-width-1-1 uk-button-primary uk-border-rounded uk-float-left" type="submit">Confirm</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
