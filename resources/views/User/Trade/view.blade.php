            ...
            <header class="header navbar navbar-expand-sm">
                ...
                <li class="nav-item more-dropdown">
                    <div class="dropdown  custom-dropdown-icon accupdate">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span>@lang('text.realBalance') <span class="accountbalance"> {{Auth::User()->rbalance}} </span> USD</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></a>

                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                            <a class="dropdown-item" data-value="@lang('text.realBalance'){{Auth::User()->rbalance}} USD" href="javascript:void(0);">@lang('text.realBalance') <span class="accountbalance"> {{Auth::User()->rbalance}} </span> USD</a>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <span style="color: #fff"> @lang('text.tradeL')</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span class="text-muted tradeduration"> </span>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </button>
            </div>
            ...
            else
            {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        {
                            $('.accupdate').html('<a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span>@lang('text.realAcc') <span class="accountbalance"> ' + response.rbalance +'</span> USD</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></a>' +

                            '<div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">'+
                                '<a class="dropdown-item" data-value="@lang('text.realAcc')' + response.rbalance +' USD" href="javascript:void(0);">@lang('text.realAcc') <span class="accountbalance"> ' + response.rbalance +' </span> USD</a>'+
                                '<a class="dropdown-item" data-value="@lang('demoAcc') ' + response.dbalance +' USD" href="javascript:void(0);">@lang('demoAcc') ' + response.dbalance +' USD</a>'+
                            ...
                            $('.moneyret').html(' <h6 class="tx-inverse"> <i class="fa fa-wallet"> </i> @lang('text.amount') <span class="text-secondary inv_amount">' + amount + ' USD</span></h6> ' +
                            ' <h6 class="tx-inverse"> <i class="fa fa-wallet"> </i> @lang('text.return') <span class="text-secondary ret_amount">' + arett + ' USD</span></h6> ');
                            ...
                            if (response.time == 1)
                            {
                                ...
                                $('.timer').html('<h6 class="tx-inverse"> <i class="fa fa-stopwatch"> </i> @lang('text.timeLeft'): <Span class="text-secondary time_left"> ' + minutes + ':' + seconds + ' </span></h6>');
            ...
            else
            {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        {
                            $('.accupdate').html('<a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span>@lang('text.realBalance') <span class="accountbalance"> ' + response.rbalance +'</span> USD</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></a>' +

                            '<div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">'+
                                '<a class="dropdown-item" data-value="@lang('text.realBalance')' + response.rbalance +' USD" href="javascript:void(0);">@lang('text.realBalance') <span class="accountbalance"> ' + response.rbalance +' </span> USD</a>'+
                                '<a class="dropdown-item" data-value="@lang('demoAcc') ' + response.dbalance +' USD" href="javascript:void(0);">@lang('demoAcc') ' + response.dbalance +' USD</a>'+
