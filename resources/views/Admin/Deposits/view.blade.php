                      ...
                      <div class="row">
                        <div class="col-sm-8">
                            @foreach ($user as $data)
                               <div class="media"><img class="img-thumbnail rounded-circle me-3" src="{{asset('storage/images/'.$data->image)}}" alt="Generic placeholder image">  
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-xl-6">
                          <div class="my-gallery" id="aniimated-thumbnials-3" itemscope="">
                            ...
                            <figure itemprop="associatedMedia" itemscope=""><a href="{{asset('storage/images/'.$data->image)}}" itemprop="contentUrl" data-size="1600x950"><img class="img-fluid rounded" src="{{asset('storage/images/'.$data->image)}}" itemprop="thumbnail" alt="gallery"></a>
